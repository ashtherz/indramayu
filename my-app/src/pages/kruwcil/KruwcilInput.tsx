        ...
        <form className="space-y-4">
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-gray-700"
            >
              Jumlah UMKM <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              id="jumlah"
              placeholder="Tulis Jumlah UMKM"
              className="block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-[#01347c] focus:border-[#01347c] sm:text-sm"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              id="nilai"
              placeholder="Tulis Nilai Kredit yang Disalurkan"
              className="block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-[#01347c] focus:border-[#01347c] sm:text-sm"
            />
          </div>
          <button
