...
const BersulingDetail: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState("");
  const [rowsPerPage, setRowsPerPage] = useState(10);
  const [currentPage, setCurrentPage] = useState(1);

  const data = [
    { no: 1, year: 2024, jumlah: 479 },
    { no: 2, year: 2023, jumlah: 365 },
    { no: 3, year: 2022, jumlah: 600 },
    { no: 4, year: 2021, jumlah: 400 },
    { no: 5, year: 2020, jumlah: 250 },
    { no: 6, year: 2019, jumlah: 175 },
    { no: 7, year: 2018, jumlah: 465 },
    { no: 8, year: 2017, jumlah: 375 },
    { no: 9, year: 2016, jumlah: 350 },
    { no: 10, year: 2015, jumlah: 250 },
  ];

  const filteredData = data.filter(
    (row) =>
      row.year.toString().includes(searchTerm) ||
      row.jumlah.toString().includes(searchTerm)
  );
...
export default BersulingDetail;
